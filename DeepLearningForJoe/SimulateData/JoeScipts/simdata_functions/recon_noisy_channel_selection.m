function [noisy_img, data0, J] = recon_noisy_channel_selection(rep, mesh, solver ,opt, data, xgrid, ygrid, zgrid, data0, J, noisy_img)
%RECON_NOISY_CHANNEL_SELECTION Summary of this function goes here
%   Detailed explanation goes here

%%%
threshold_fl = mean(data.amplitudefl);% + std(data.amplitudefl);
threshold_xx = mean(data.amplitudex);% + std(data.amplitudex);
%%%
...
tmp1 = data0.amplitudefl./data0.amplitudex;
